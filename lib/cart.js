...
export const PRODUCTS = [
  { id:"idli-1kg", name:"Idli & Dosa Batter", size:"1 kg", mrp: 90, price:80, usp:["No preservatives","Wet‑grinder texture","Naturally fermented"] },
  { id:"idli-2kg", name:"Idli & Dosa Batter", size:"2 kg (family pack)", mrp:180, price:150, usp:["Best value","Fluffy idlis","Crisp dosas"] },
];
